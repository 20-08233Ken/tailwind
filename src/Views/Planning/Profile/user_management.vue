...
<template>
    <div class="w-10/12 flex flex-col px-3vw py-3vw  bg-white shadow-card2">
        ...
        <span class="flex mt-16 justify-between"> 
            ...
            <button class="btn bg-white border-0 text-Red-Darken gap-2 shadow-0">
                ...
                <tr>
                    ...
                    <td class="flex items-center gap-4">
                        ...
                        <span class="flex flex-col">
                            <p class="font-Subheader">John Doe</p>
                            <p class="text-0.9">johndoe@domain.com</p>
                        </span>
                    </td>

                    <td>Main Campus I</td>
                    <td>IPDO</td>
                    <td>Planning Officer II <br>Instructor I</td>
