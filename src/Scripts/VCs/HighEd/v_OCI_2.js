...
export default{
    ...
    methods:{
        ...
        async GetHEPData(){
            ...
            await axios.post(import.meta.env.VITE_API_APPROVE_DISPLAY_TWO_HEP,{
        ...
        async ApprovedRequest(){
            try{
                ...
                const response = await axios.post(import.meta.env.VITE_API_APPROVE_HEP_TWO, {
        ...
        async RejectRequest(){
            try{
                ...
                let users_list = this.cookies.get('userCookies');
                const response = await axios.post(import.meta.env.VITE_API_DISAPPROVE_HEP_TWO, {
                    "office": users_list.office,
                    "campus_id": users_list.campus_id,
                    "user_id": users_list.id,
                    "id":   this.selectedID,
